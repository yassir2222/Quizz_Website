...
if(isset($_POST['submit'])){
    ...
    if (empty($Username)) {  
        $Error_Username = "Name is required";  
        $msg="<div class='alert alert-danger'>$Error_Username</div>"; 
    ...
    $etudiant=new Etudiant($name,$Username,$email,$Password);
    $insertion=$etudiant->insertEtudiant($conn);
    if($insertion){
...
<div class="card mb-5 mx-auto mt-5" style="max-width: 900px;" id="Card_SigneUp">
  <div class="row g-0">
    <div class="col-md-4" style="width: 400px;">
      <img src="image/signeUp3.png" class="img-fluid rounded-start" style="height: 400px; margin: 15px;">
    </div>
    <div class="col-md-8" style="width: 450px;  padding: 15px;">
      ...
      <div class="header__center1"><h2 class="ms-2 text-center" id="title">Signe Up</h2></div><br>
        <form action="" method="post">
            ...
            <button type="submit" class="btn btn-info" name="submit" style="width: 100%;">Submit</button>
        </form>
      </div>
    </div>
  </div>
